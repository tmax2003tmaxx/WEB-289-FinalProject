...
<head>
	...
	<link href="css/smallest.css" rel="stylesheet" media="screen and (max-width: 500px)">
	...
	<div id="wrapper">
		...
		<div id="logIn">
			<?php if(isset($_SESSION["f_name"])) { ?>
				<a href="index.php?action=logout" title="Logout">Logout <?php echo $_SESSION["f_name"]; ?></a>
			<?php } else { ?>
		...
		<footer>
			<p>Copyright &copy; 2016 Bake My Day</p>
		</footer>
	</div>
